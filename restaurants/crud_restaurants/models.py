...
class City(models.Model):
    ...
    city_state = models.ForeignKey(State, null=True, on_delete=models.SET_NULL)
    city_zip = models.ForeignKey(ZipCode, null=True, on_delete=models.SET_NULL)
...
class Restaurant(models.Model):
    ...
    restaurant_city = models.ForeignKey(City, null=True, on_delete=models.SET_NULL)
    restaurant_state = models.ForeignKey(State, null=True, on_delete=models.SET_NULL)
    restaurant_zip = models.ForeignKey(ZipCode, null=True, on_delete=models.SET_NULL)
    def __str__(self):
